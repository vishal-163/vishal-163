...
<details open>
<summary><b>AI Trip Planner</b> &nbsp;<img src="https://img.shields.io/badge/status-completed-8A85FF?style=flat-square"/></summary>
<br/>

Cross-platform mobile app generating personalized AI-based travel itineraries based on user preferences, budget, and duration.

- Three-tier architecture — Flutter frontend, Supabase backend, dedicated AI service layer
- Deterministic JSON pipeline for reliable, seamless UI rendering
- Secure auth (email + OAuth), row-level security, normalized schema
- Full CRUD with real-time sync via Supabase subscriptions
...
<details open>
<summary><b>Smart Military Vest — IoT Defence System</b> &nbsp;<img src="https://img.shields.io/badge/status-in--progress-FFB000?style=flat-square"/></summary>
<br/>

Defence-grade wearable for real-time soldier health monitoring — heart rate, SpO2, temperature, and motion tracking.

- Multi-sensor integration via I2C and SPI for efficient on-device data aggregation
- Dual-channel LoRa + GSM/4G communication, AES-256 encrypted
- Intelligent alert system for automated distress signal generation
- Scalable backend with MQTT, time-series DB, and a command-centre analytics dashboard

<img src="https://img.shields.io/badge/-ESP32-E7352C?style=flat-square&logo=espressif&logoColor=white"/> <img src="https://img.shields.io/badge/-LoRa-2C3E50?style=flat-square"/> <img src="https://img.shields.io/badge/-GSM%2F4G-2C3E50?style=flat-square"/> <img src="https://img.shields.io/badge/-MQTT-660066?style=flat-square&logo=mqtt&logoColor=white"/> <img src="https://img.shields.io/badge/-IoT-00979D?style=flat-square"/>
</details>
...
**B.E. Computer Science and Engineering** — K.S. Institute of Technology, Bangalore — *Expected 2027*
